...
class ModelContract (models.Model):
    ...
    type_contract = fields.Many2one ("hr.type.contract", "Type de contrat", required=True)
...
class ContractGenerator (models.Model):
    ...
    _description = "Generation de contrat"
    ...
    def generate_contract(self):
        ...
        for employee in self.employee_ids:
            vals = {
                'model_contract_id': self.model_contract_id.id,
                ...
                'structure_type_id': self.model_contract_id.structure_salariale.id,
                'hr_convention_id': self.model_contract_id.convention_id.id,
                'hr_secteur_id': self.model_contract_id.secteur_activite_id.id,
                'contract_type_id': self.model_contract_id.type_contract.id,
    ...
    employee_ids = fields.Many2many ("hr.employee", "hr_model_contract_rel", "hr_model_contract_id", "employee_id",
                                     "Employees")
